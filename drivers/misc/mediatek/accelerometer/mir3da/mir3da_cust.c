...
extern bool current_mode_is_fatory;
...
static int mir3da_get_data(int *x , int *y, int *z, int *status)
{
	...
	*status = SENSOR_STATUS_ACCURACY_MEDIUM;
	...
	if( current_mode_is_fatory == false)
	{
				*x = 9700;
				*y = 1000;
				//*z = 1000;
