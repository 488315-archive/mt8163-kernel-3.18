...
static unsigned int charging_hw_init(void *data)
{
	...
	bq24296_set_vindpm(0x8); /*VIN DPM check 4.68V*/  //e:5.0v
...
#endif
#else
	bq24296_set_vreg(0x2d); /*VREG 4.208V*/
